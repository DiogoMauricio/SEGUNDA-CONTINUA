        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Imagen = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ...
                    MetrosCuadrados = table.Column<double>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Visita_FechaInicio_FechaFin", "FechaInicio < FechaFin");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 2, "Santiago", "DEPT-001", "Av. Providencia 1234, Providencia", 2, "https://via.placeholder.com/400x300/0066CC/FFFFFF?text=Departamento", 75.5, 2500000m, 0, "Departamento Moderno en Centro" },
                    { 2, true, 3, "Las Condes", "CASA-002", "Los Leones 456, Las Condes", 4, "https://via.placeholder.com/400x300/228B22/FFFFFF?text=Casa", 180.0, 4200000m, 1, "Casa Familiar con Jardín" },
                    { 3, true, 2, "Santiago Centro", "OFIC-003", "Av. Apoquindo 789, Las Condes", 0, "https://via.placeholder.com/400x300/4B0082/FFFFFF?text=Oficina", 120.0, 1800000m, 2, "Oficina Ejecutiva Torre Corporativa" },
                    { 4, true, 1, "Maipú", "LOCAL-004", "Av. Américo Vespucio 321, Maipú", 0, "https://via.placeholder.com/400x300/FF6347/FFFFFF?text=Local", 45.5, 950000m, 3, "Local Comercial en Mall" }
                });
